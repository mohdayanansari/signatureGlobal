...
export default function Chat(props) {
  ...
  const NewChatListItem = ({name, number, status, messages,time, onClickItem , id , unseenCount})=> {
    return(
        <>
          <div key={id} className="p-[15px] my-[5px] flex w-full rounded cursor-pointer hover:bg-appGray-200" onClick={()=>onClickItem(id , name)}>
              ...
              <div className="flex gap-4 ">
                ...
                <div>
                  ...
                  <div className="bg-appPurple-300 min-w-[150px] rounded-lg  p-[10px] custom-design-chat-container">
                    ...
                    <div className={"p-2 bg-appGray-400 rounded flex items-center"}>
                      <div className={"bg-appPurple-500 mr-[10px] rounded w-[40px] h-[40px] flex justify-center items-center"}>
                        <DocumentTextIcon className={"text-appPurple-400 w-[25px] h-[25px]"}/>
                      </div>
                      <p className="text-sm text-white font-regular text-opacity-80">{item?.text?.name}</p>
                    </div>
                    <div className="flex justify-end mt-[5px] text-white text-opacity-50 gap-[2px] items-center ">
                      {/*<ClockIcon className="w-[12px] h-[12px] mt-[2px]" />*/}
                      {item?.status && getStatusText(item?.status)}
                ...
                <div className="">
                  ...
                  <div className="bg-appGray-300 min-w-[150px] rounded-lg  p-[10px] custom-design-chat-right-container">
                    ...
                    <div className={"p-2 bg-appGray-400 rounded flex items-center"}>
                      ...
                      <p className="text-sm text-white font-regular text-opacity-80">{item?.filename}</p>
                    </div>
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-8 overflow-hidden">
            ...
            <UserHead
                ...
                number={selectedChat}/>
            <div  ref={chatListRef} className={classnames(((chatHistory?.length == 0 || chatHistoryLoading)  && "flex justify-center items-center")," chat-custom-scroll bg-appGray-700 overflow-y-auto scrollbar scrollbar-thumb-appPurple-200 scrollbar-track-transparent scrollbar-thin scrollbar-thumb-rounded px-[30px]")}>
              {
                chatHistoryLoading
                        ...
                        <div className="my-[20px]">
                          {
                            chatHistory?.length > 0
                              ...
                              : <h1 className={"text-4xl text-white text-opacity-80 "}>You don't have messages yet</h1>
                          }
                        </div>
                    )
              }
